...
const STEPS = [
  'Зарегистрируйтесь на сайте и настройте свой профиль.',
  'Проходите мини-игры и сценарии на карте попутно обучаясь фин. грамотности.',
  'Получайте алмазы, опыт и открывайте новые уровни вырываясь в лидеры среди других.',
];
